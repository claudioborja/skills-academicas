...
```text
Usa $planificador-obra-academica para diseñar e inicializar la estructura completa de este libro.
```
...
- Para diseño de índices y secuencias: lee [references/arquitectura-de-obra.md](../../planificador-obra-academica/references/arquitectura-de-obra.md).
- Para carpetas, responsabilidades y compatibilidad: lee [references/estructura-directorios-libro.md](../../planificador-obra-academica/references/estructura-directorios-libro.md).
...
| Recurso | Función |
| --- | --- |
| [`scripts/inicializar_proyecto_libro.py`](../../planificador-obra-academica/scripts/inicializar_proyecto_libro.py) | Inicializar la estructura editorial canónica de un proyecto de libro. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/arquitectura-de-obra.md`](../../planificador-obra-academica/references/arquitectura-de-obra.md) | Arquitectura de obra |
| [`references/estructura-directorios-libro.md`](../../planificador-obra-academica/references/estructura-directorios-libro.md) | Estructura canónica de proyectos de libro |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_inicializacion_segura.py`](../../planificador-obra-academica/tests/test_inicializacion_segura.py) | Recurso auxiliar: Test inicializacion segura. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../planificador-obra-academica/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`planificador-obra-academica/SKILL.md`](../../planificador-obra-academica/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
