...
```text
Usa $gestor-contribuciones-autoria para elegir y aplicar el perfil de contribuciones, autoría y metadatos adecuado para esta obra.
```
...
Usar [selección de perfiles](../../gestor-contribuciones-autoria/references/seleccion-perfiles.md) y aplicar solo las capas necesarias:
...
Usar [roles CRediT](../../gestor-contribuciones-autoria/references/roles-credit.md) para evitar asignaciones basadas únicamente en el cargo, antigüedad, financiación, supervisión nominal o posición jerárquica. No asignar contribuciones a herramientas de IA ni tratarlas como autoras responsables.

#### 3. Evaluar autoría por separado

Leer [autoría y responsabilidad](../../gestor-contribuciones-autoria/references/autoria-responsabilidad.md). Aplicar todos los criterios acumulativos cuando la política lo exija. Clasificar cada participación como:
...
Leer [representación técnica](../../gestor-contribuciones-autoria/references/representacion-tecnica.md) solo para los destinos solicitados. Mantener el término canónico junto con su vocabulario y, cuando exista, URI o código. Conservar nombres de visualización separados de identificadores y afiliaciones.
...
Consultar [fuentes oficiales](../../gestor-contribuciones-autoria/references/fuentes-oficiales.md) antes de afirmar vigencia, obligatoriedad o compatibilidad técnica.
...
| Recurso | Función |
| --- | --- |
| [`scripts/seleccionar_perfil.py`](../../gestor-contribuciones-autoria/scripts/seleccionar_perfil.py) | Recomienda un perfil de contribución, autoría y metadatos desde contexto JSON. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/autoria-responsabilidad.md`](../../gestor-contribuciones-autoria/references/autoria-responsabilidad.md) | Autoría, responsabilidad e integridad |
| [`references/fuentes-oficiales.md`](../../gestor-contribuciones-autoria/references/fuentes-oficiales.md) | Fuentes oficiales |
| [`references/representacion-tecnica.md`](../../gestor-contribuciones-autoria/references/representacion-tecnica.md) | Representación técnica |
| [`references/roles-credit.md`](../../gestor-contribuciones-autoria/references/roles-credit.md) | Roles CRediT |
| [`references/seleccion-perfiles.md`](../../gestor-contribuciones-autoria/references/seleccion-perfiles.md) | Selección de perfiles |

### Plantillas y recursos

| Recurso | Función |
| --- | --- |
| [`assets/contexto-ejemplo.json`](../../gestor-contribuciones-autoria/assets/contexto-ejemplo.json) | Datos estructurados o ejemplo: Contexto ejemplo. |
| [`assets/matriz-contribuciones.csv`](../../gestor-contribuciones-autoria/assets/matriz-contribuciones.csv) | Plantilla o registro editable: Matriz contribuciones. |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_seleccionar_perfil.py`](../../gestor-contribuciones-autoria/tests/test_seleccionar_perfil.py) | Pruebas funcionales del selector de perfiles de contribución y autoría. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../gestor-contribuciones-autoria/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`gestor-contribuciones-autoria/SKILL.md`](../../gestor-contribuciones-autoria/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
