...
```text
Usa $revisor-citas-consistencia-bibliografica para revisar la consistencia entre citas y bibliografía.
```
...
| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../revisor-citas-consistencia-bibliografica/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`revisor-citas-consistencia-bibliografica/SKILL.md`](../../revisor-citas-consistencia-bibliografica/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
