...
```text
Usa $gestor-referencias-academicas para respaldar este texto con fuentes verificadas y aplicar la norma APA 7 o IEEE del proyecto.
```
...
- **Formato APA 7:** leer [references/apa7-practico.md](../../gestor-referencias-academicas/references/apa7-practico.md).
- **Formato IEEE:** leer [references/ieee-practico.md](../../gestor-referencias-academicas/references/ieee-practico.md).
...
3. En modo de respaldo, identificar la afirmación concreta y sus límites; buscar fuentes pertinentes según [references/busqueda-y-descarga.md](../../gestor-referencias-academicas/references/busqueda-y-descarga.md).
...
| Recurso | Función |
| --- | --- |
| [`scripts/pdf_a_contexto.py`](../../gestor-referencias-academicas/scripts/pdf_a_contexto.py) | Convierte PDFs academicos en un paquete de lectura compacto para el skill |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/apa7-practico.md`](../../gestor-referencias-academicas/references/apa7-practico.md) | APA 7: citas y referencias |
| [`references/busqueda-y-descarga.md`](../../gestor-referencias-academicas/references/busqueda-y-descarga.md) | Búsqueda, lectura y trazabilidad |
| [`references/ieee-practico.md`](../../gestor-referencias-academicas/references/ieee-practico.md) | IEEE: citas y referencias |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_descargas.py`](../../gestor-referencias-academicas/tests/test_descargas.py) | Recurso auxiliar: Test descargas. |
| [`tests/test_extractor.py`](../../gestor-referencias-academicas/tests/test_extractor.py) | El extractor común conserva el contenido sin imponer un estilo de cita. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../gestor-referencias-academicas/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`gestor-referencias-academicas/SKILL.md`](../../gestor-referencias-academicas/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
