...
```text
Usa $filtro-editoriales-depredadoras para verificar si estas fuentes, revistas o editoriales son confiables antes de citarlas.
```
...
- Para criterios y fuentes de verificación: lee [references/criterios-verificacion.md](../../filtro-editoriales-depredadoras/references/criterios-verificacion.md).
- Para la lista local resumida del proyecto: lee [references/lista-alerta-local.md](../../filtro-editoriales-depredadoras/references/lista-alerta-local.md).
- Para coincidencias rápidas por nombre: usa [scripts/check_editorial_risk.py](../../filtro-editoriales-depredadoras/scripts/check_editorial_risk.py).
...
| Recurso | Función |
| --- | --- |
| [`scripts/check_editorial_risk.py`](../../filtro-editoriales-depredadoras/scripts/check_editorial_risk.py) | Check journal/publisher names against the local editorial-risk watchlist. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/criterios-verificacion.md`](../../filtro-editoriales-depredadoras/references/criterios-verificacion.md) | Criterios de verificación editorial |
| [`references/lista-alerta-local.md`](../../filtro-editoriales-depredadoras/references/lista-alerta-local.md) | Lista local de alerta editorial |
| [`references/watchlist.json`](../../filtro-editoriales-depredadoras/references/watchlist.json) | Datos estructurados o ejemplo: Watchlist. |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_coincidencias.py`](../../filtro-editoriales-depredadoras/tests/test_coincidencias.py) | Recurso auxiliar: Test coincidencias. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../filtro-editoriales-depredadoras/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`filtro-editoriales-depredadoras/SKILL.md`](../../filtro-editoriales-depredadoras/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
