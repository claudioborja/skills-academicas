...
```text
Usa $verificador-resultados-investigacion para verificar estos resultados, explicar cada hallazgo y preparar intervenciones trazables sin alterar las fuentes originales.
```
...
Leer [revisión cuantitativa](../../verificador-resultados-investigacion/references/revision-cuantitativa.md) cuando existan cifras o análisis estadísticos. Aplicar en capas:
...
Leer [revisión cualitativa](../../verificador-resultados-investigacion/references/revision-cualitativa.md) cuando haya categorías, temas, codificación, entrevistas u observaciones. Comprobar trazabilidad entre afirmación, fragmentos o unidades de significado, matriz de análisis y procedimiento declarado.
...
Leer [informe de intervención](../../verificador-resultados-investigacion/references/informe-intervencion.md). Cada error, inconsistencia o resultado no verificable debe tener un informe individual con:
...
Consultar [protocolo](../../verificador-resultados-investigacion/references/protocolo-verificacion.md), [fuentes oficiales](../../verificador-resultados-investigacion/references/fuentes-oficiales.md) y solo la referencia cuantitativa o cualitativa pertinente al caso.
...
| Recurso | Función |
| --- | --- |
| [`scripts/verificar_resultados.py`](../../verificador-resultados-investigacion/scripts/verificar_resultados.py) | Verifica cálculos mecánicos y genera informes trazables por hallazgo. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/fuentes-oficiales.md`](../../verificador-resultados-investigacion/references/fuentes-oficiales.md) | Fuentes oficiales y guías |
| [`references/informe-intervencion.md`](../../verificador-resultados-investigacion/references/informe-intervencion.md) | Informe de intervención |
| [`references/protocolo-verificacion.md`](../../verificador-resultados-investigacion/references/protocolo-verificacion.md) | Protocolo de verificación |
| [`references/revision-cualitativa.md`](../../verificador-resultados-investigacion/references/revision-cualitativa.md) | Revisión cualitativa |
| [`references/revision-cuantitativa.md`](../../verificador-resultados-investigacion/references/revision-cuantitativa.md) | Revisión cuantitativa |

### Plantillas y recursos

| Recurso | Función |
| --- | --- |
| [`assets/registro-intervenciones.csv`](../../verificador-resultados-investigacion/assets/registro-intervenciones.csv) | Plantilla o registro editable: Registro intervenciones. |
| [`assets/registro-resultados-ejemplo.json`](../../verificador-resultados-investigacion/assets/registro-resultados-ejemplo.json) | Datos estructurados o ejemplo: Registro resultados ejemplo. |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_verificar_resultados.py`](../../verificador-resultados-investigacion/tests/test_verificar_resultados.py) | Pruebas funcionales del verificador mecánico de resultados. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../verificador-resultados-investigacion/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`verificador-resultados-investigacion/SKILL.md`](../../verificador-resultados-investigacion/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
