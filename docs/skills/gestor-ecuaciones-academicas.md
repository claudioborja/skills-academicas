...
```text
Usa $gestor-ecuaciones-academicas para revisar las ecuaciones, símbolos, unidades y referencias de este manuscrito.
```
...
Leer [formatos, notación y control editorial](../../gestor-ecuaciones-academicas/references/formatos-y-control.md) cuando haya conversión, exigencias APA/IEEE, unidades, matrices, sistemas o accesibilidad.
...
| Recurso | Función |
| --- | --- |
| [`scripts/auditar_ecuaciones.py`](../../gestor-ecuaciones-academicas/scripts/auditar_ecuaciones.py) | Inventaría ecuaciones LaTeX/Markdown y revisa referencias mecánicas. |
| [`scripts/normalizar_ecuaciones_word.py`](../../gestor-ecuaciones-academicas/scripts/normalizar_ecuaciones_word.py) | Normaliza espacios OMML y tablas de numeración de ecuaciones en un DOCX. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/formatos-y-control.md`](../../gestor-ecuaciones-academicas/references/formatos-y-control.md) | Formatos, notación y control editorial |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_auditar_ecuaciones.py`](../../gestor-ecuaciones-academicas/tests/test_auditar_ecuaciones.py) | Pruebas funcionales del auditor de ecuaciones académicas. |
| [`tests/test_normalizar_ecuaciones_word.py`](../../gestor-ecuaciones-academicas/tests/test_normalizar_ecuaciones_word.py) | Pruebas funcionales de normalización de ecuaciones OMML en DOCX. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../gestor-ecuaciones-academicas/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`gestor-ecuaciones-academicas/SKILL.md`](../../gestor-ecuaciones-academicas/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
