...
```text
Usa $convertidor-tesis-a-libro para diagnosticar esta tesis y convertirla en una arquitectura de libro publicable.
```
...
| Recurso | Función |
| --- | --- |
| [`scripts/diagnosticar_tesis.py`](../../convertidor-tesis-a-libro/scripts/diagnosticar_tesis.py) | Recurso auxiliar: Diagnosticar tesis. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/arquitectura-libro-derivado.md`](../../convertidor-tesis-a-libro/references/arquitectura-libro-derivado.md) | Arquitectura De Un Libro Académico Derivado De Una Tesis |
| [`references/mapa-transformacion.md`](../../convertidor-tesis-a-libro/references/mapa-transformacion.md) | Mapa De Transformación Tesis A Libro |
| [`references/marcas-de-tesis.md`](../../convertidor-tesis-a-libro/references/marcas-de-tesis.md) | Marcas De Tesis Que Conviene Transformar |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_diagnosticar_tesis.py`](../../convertidor-tesis-a-libro/tests/test_diagnosticar_tesis.py) | Recurso auxiliar: Test diagnosticar tesis. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../convertidor-tesis-a-libro/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`convertidor-tesis-a-libro/SKILL.md`](../../convertidor-tesis-a-libro/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
