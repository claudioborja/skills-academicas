...
```text
Usa $gestor-codigo-tecnico-editorial para preparar y revisar los listados de código de este manuscrito técnico.
```
...
Leer [references/criterios-listados.md](../../gestor-codigo-tecnico-editorial/references/criterios-listados.md) para decidir cuándo publicar código completo, fragmentos, pseudocódigo, configuración o salidas.
...
| Recurso | Función |
| --- | --- |
| [`scripts/archivos_seguros.py`](../../gestor-codigo-tecnico-editorial/scripts/archivos_seguros.py) | Publicar el DOCX sin sobrescrituras implícitas ni salidas peligrosas. |
| [`scripts/auditar_listados_codigo.py`](../../gestor-codigo-tecnico-editorial/scripts/auditar_listados_codigo.py) | Audita señales editoriales básicas de bloques de código Markdown. |
| [`scripts/generar_listado_docx.py`](../../gestor-codigo-tecnico-editorial/scripts/generar_listado_docx.py) | Generar un listado DOCX nativo y breve sin depender de LibreOffice. |
| [`scripts/requirements-lock.txt`](../../gestor-codigo-tecnico-editorial/scripts/requirements-lock.txt) | Dependencias Python fijadas para esta herramienta. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/criterios-listados.md`](../../gestor-codigo-tecnico-editorial/references/criterios-listados.md) | Criterios para listados de código |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_auditar_listados_codigo.py`](../../gestor-codigo-tecnico-editorial/tests/test_auditar_listados_codigo.py) | Recurso auxiliar: Test auditar listados codigo. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../gestor-codigo-tecnico-editorial/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`gestor-codigo-tecnico-editorial/SKILL.md`](../../gestor-codigo-tecnico-editorial/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
