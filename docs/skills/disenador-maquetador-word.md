...
```text
Usa $disenador-maquetador-word para diseñar y maquetar este libro como un DOCX profesional, editable y preparado para futuras revisiones.
```
...
Construir o depurar el sistema de estilos antes de ajustar páginas individuales. Usar nombres funcionales y una jerarquía inequívoca. Configurar secciones, encabezados, pies, numeración, tabla de contenido, leyendas y referencias según [arquitectura DOCX editable](../../disenador-maquetador-word/references/arquitectura-docx-editable.md).
...
Renderizar una copia temporal del DOCX y revisar el libro como páginas. El renderizado es un instrumento de control, no un cambio de formato del entregable. Seguir [control de calidad visual](../../disenador-maquetador-word/references/control-calidad-visual.md), corregir la fuente DOCX y volver a renderizar las páginas afectadas.
...
| Recurso | Función |
| --- | --- |
| [`references/arquitectura-docx-editable.md`](../../disenador-maquetador-word/references/arquitectura-docx-editable.md) | Arquitectura de un DOCX editable |
| [`references/control-calidad-visual.md`](../../disenador-maquetador-word/references/control-calidad-visual.md) | Control de calidad visual en Word |
| [`references/direccion-visual-y-perfiles.md`](../../disenador-maquetador-word/references/direccion-visual-y-perfiles.md) | Dirección visual y perfiles para libros en Word |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../disenador-maquetador-word/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`disenador-maquetador-word/SKILL.md`](../../disenador-maquetador-word/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
