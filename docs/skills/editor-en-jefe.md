...
```text
Usa $editor-en-jefe para diagnosticar este proyecto y decidir qué skills activar en cada etapa.
```
...
Consultar [references/mapa-responsabilidades.md](../../editor-en-jefe/references/mapa-responsabilidades.md) para elegir la skill y sus límites. Cada script especializado pertenece a su skill; el lanzador general está en `scripts/ejecutar.py`.
...
- Aplicar [references/perfiles-editoriales.md](../../editor-en-jefe/references/perfiles-editoriales.md) para la precedencia entre encargo, protocolo, norma y perfil. Registrar preferencias en la ficha existente del proyecto; no replicar reglas numéricas en cada skill.
...
Cuando se reciba un contexto maestro, ficha editorial o documento de tipo de obra, aplicar primero [interpretación del contexto editorial](../../editor-en-jefe/references/interpretacion-contexto-editorial.md). Separar estructura publicable, instrucciones de desarrollo y controles de calidad. Entregar esa separación al planificador y a las skills de redacción y revisión; ninguna debe convertir una lista de instrucciones en el índice por defecto.
...
- Para preparar un equipo, usar `scripts/instalar_requisitos.py`: comprueba e instala el conjunto completo de PDF/Word, imágenes, gráficos y mantenimiento desde un requirements plano, en el Python actual (3.12+), reutilizando paquetes compatibles. El aislamiento es opcional con `--entorno RUTA`; `--comprobar` diagnostica sin escribir. Funciona en Windows, Linux y macOS; no instala Python ni herramientas externas. No fuerza instalaciones sobre un Python protegido por el sistema. Ejecutarlo cuando el encargo requiera preparar dependencias, no durante cada tarea editorial. Consultar [portabilidad](../../editor-en-jefe/references/portabilidad.md#instalador-de-requerimientos).

- Para mantenimiento, `scripts/validar_coleccion.py` reúne estructura, pruebas, dependencias y comparación de copias. Consultar [validación unificada](../../editor-en-jefe/references/portabilidad.md#validación-unificada). No instala ni sincroniza archivos y no presenta pruebas omitidas como aprobación.
...
- [references/portabilidad.md](../../editor-en-jefe/references/portabilidad.md): ejecución, Python y pruebas.
- [references/perfiles-editoriales.md](../../editor-en-jefe/references/perfiles-editoriales.md): políticas y formato del proyecto.
- [references/mapa-responsabilidades.md](../../editor-en-jefe/references/mapa-responsabilidades.md): selección de especialidades.
- [references/ruta-de-trabajo.md](../../editor-en-jefe/references/ruta-de-trabajo.md) y [references/diagnostico-por-etapa.md](../../editor-en-jefe/references/diagnostico-por-etapa.md): orientación adicional por etapa.
- [references/migracion-27-skills.md](../../editor-en-jefe/references/migracion-27-skills.md): equivalencias y recuperación tras la fusión; solo para mantenimiento.
- [references/auditoria-automatizacion.md](../../editor-en-jefe/references/auditoria-automatizacion.md): registro histórico, no certificado de validez vigente.
...
| Recurso | Función |
| --- | --- |
| [`scripts/archivos_seguros.py`](../../editor-en-jefe/scripts/archivos_seguros.py) | Validación y publicación de archivos sin sobrescritura implícita. |
| [`scripts/ejecutar.py`](../../editor-en-jefe/scripts/ejecutar.py) | Ejecutar las herramientas de esta colección en Linux, Windows o macOS. |
| [`scripts/generar_documentacion_skills.py`](../../editor-en-jefe/scripts/generar_documentacion_skills.py) | Genera fichas Markdown navegables para una colección de skills. |
| [`scripts/instalar_requisitos.py`](../../editor-en-jefe/scripts/instalar_requisitos.py) | Preparar dependencias en el Python actual; entorno virtual opcional en los tres sistemas. |
| [`scripts/preparar_runtime_portable.py`](../../editor-en-jefe/scripts/preparar_runtime_portable.py) | Descargar y empaquetar intérpretes Python standalone por plataforma. |
| [`scripts/requirements-mantenimiento.txt`](../../editor-en-jefe/scripts/requirements-mantenimiento.txt) | Dependencias Python fijadas para esta herramienta. |
| [`scripts/requirements.txt`](../../editor-en-jefe/scripts/requirements.txt) | Dependencias Python fijadas para esta herramienta. |
| [`scripts/validar_coleccion.py`](../../editor-en-jefe/scripts/validar_coleccion.py) | Validar estructura, pruebas, dependencias y copias sin instalar ni sincronizar. |

### Referencias

| Recurso | Función |
| --- | --- |
| [`references/auditoria-automatizacion.md`](../../editor-en-jefe/references/auditoria-automatizacion.md) | Auditoria de automatizacion de skills |
| [`references/diagnostico-por-etapa.md`](../../editor-en-jefe/references/diagnostico-por-etapa.md) | Diagnostico por etapa |
| [`references/interpretacion-contexto-editorial.md`](../../editor-en-jefe/references/interpretacion-contexto-editorial.md) | Interpretación del contexto editorial |
| [`references/mapa-responsabilidades.md`](../../editor-en-jefe/references/mapa-responsabilidades.md) | Mapa de responsabilidades |
| [`references/migracion-27-skills.md`](../../editor-en-jefe/references/migracion-27-skills.md) | Reorganización de la colección: 29 a 27 skills |
| [`references/perfiles-editoriales.md`](../../editor-en-jefe/references/perfiles-editoriales.md) | Perfil del proyecto y precedencia |
| [`references/portabilidad.md`](../../editor-en-jefe/references/portabilidad.md) | Ejecución en Linux, Windows y macOS |
| [`references/produccion-editorial-eficiente.md`](../../editor-en-jefe/references/produccion-editorial-eficiente.md) | Producción editorial integrada |
| [`references/ruta-de-trabajo.md`](../../editor-en-jefe/references/ruta-de-trabajo.md) | Ruta de trabajo |

### Pruebas

| Recurso | Función |
| --- | --- |
| [`tests/test_flujos_seguros.py`](../../editor-en-jefe/tests/test_flujos_seguros.py) | Recurso auxiliar: Test flujos seguros. |
| [`tests/test_generar_documentacion.py`](../../editor-en-jefe/tests/test_generar_documentacion.py) | Pruebas funcionales del generador de documentación de skills. |
| [`tests/test_informes_seguros.py`](../../editor-en-jefe/tests/test_informes_seguros.py) | Regresiones de conservación al invocar los informes sin el lanzador. |
| [`tests/test_instalar_requisitos.py`](../../editor-en-jefe/tests/test_instalar_requisitos.py) | Recurso auxiliar: Test instalar requisitos. |
| [`tests/test_portabilidad.py`](../../editor-en-jefe/tests/test_portabilidad.py) | Pruebas ejecutables en Linux, Windows y macOS, sin descargas. |
| [`tests/test_publicacion_stream.py`](../../editor-en-jefe/tests/test_publicacion_stream.py) | Recurso auxiliar: Test publicacion stream. |
| [`tests/test_registros_seguros.py`](../../editor-en-jefe/tests/test_registros_seguros.py) | Recurso auxiliar: Test registros seguros. |
| [`tests/test_runtime_portable_assets.py`](../../editor-en-jefe/tests/test_runtime_portable_assets.py) | Recurso auxiliar: Test runtime portable assets. |
| [`tests/test_runtime_portable_bundle.py`](../../editor-en-jefe/tests/test_runtime_portable_bundle.py) | Recurso auxiliar: Test runtime portable bundle. |
| [`tests/test_salidas_restantes.py`](../../editor-en-jefe/tests/test_salidas_restantes.py) | Recurso auxiliar: Test salidas restantes. |
| [`tests/test_seguridad.py`](../../editor-en-jefe/tests/test_seguridad.py) | Recurso auxiliar: Test seguridad. |
| [`tests/test_validar_coleccion.py`](../../editor-en-jefe/tests/test_validar_coleccion.py) | Recurso auxiliar: Test validar coleccion. |

### Configuración de interfaz

| Recurso | Función |
| --- | --- |
| [`agents/openai.yaml`](../../editor-en-jefe/agents/openai.yaml) | Metadatos de interfaz e invocación de la skill. |

## Fuente normativa

Esta ficha se genera desde [`editor-en-jefe/SKILL.md`](../../editor-en-jefe/SKILL.md), que permanece como contrato normativo. Regenera la ficha después de modificar ese archivo.
