...
El catálogo contiene 30 skills. Sus fichas se regeneran desde los recursos locales; los `SKILL.md` son las instrucciones normativas. El README principal y esta guía se mantienen manualmente. Para revisiones, Kitchenham y PRISMA son rutas separadas: Kitchenham gobierna su metodología en ingeniería de software; PRISMA gobierna el reporte y exige declarar aparte el método de conducción.
