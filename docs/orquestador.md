...
| Cierre editorial | [`gestor-contribuciones-autoria`](skills/gestor-contribuciones-autoria.md), [`gestor-control-editorial-libros`](skills/gestor-control-editorial-libros.md), [`disenador-maquetador-word`](skills/disenador-maquetador-word.md), [`maquetacion-academica-preentrega`](skills/maquetacion-academica-preentrega.md) |
...
- [`gestor-control-editorial-libros`](../gestor-control-editorial-libros/SKILL.md) separa admisibilidad y prepublicación, selecciona front matter y aplica BKCI solo como perfil editorial declarado.
...
```text
Usa $gestor-control-editorial-libros para seleccionar el front matter y documentar los controles pendientes antes de publicar este libro.
```
