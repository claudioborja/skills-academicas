...
- Para criterios de corrección de estilo: lee [references/criterios-estilo.md](references/criterios-estilo.md).
- Para decisiones ortotipográficas frecuentes: lee [references/criterios-ortotipografia.md](references/criterios-ortotipografia.md).
