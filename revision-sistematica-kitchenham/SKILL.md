...
- [references/metodologia-kitchenham.md](references/metodologia-kitchenham.md) antes de planificar las fases.
- [references/artefactos-respaldos.md](references/artefactos-respaldos.md) antes de crear, descargar o respaldar archivos.
- [references/descarga-revision-manual.md](references/descarga-revision-manual.md) antes de admitir, analizar o citar cualquier fuente.
- [references/cobertura-impacto-novedad.md](references/cobertura-impacto-novedad.md) antes de diseñar o auditar búsquedas, actualidad, impacto, novedad o excepciones.
- [references/evaluacion-calidad-sintesis.md](references/evaluacion-calidad-sintesis.md) antes de calidad, extracción o síntesis.
- [references/coordinacion-skills.md](references/coordinacion-skills.md) antes de activar apoyos.
- [references/fuentes-base.md](references/fuentes-base.md) para distinguir la función de los documentos metodológicos adjuntos.
