---
name: gestor-marco-teorico-estado-del-arte
description: Úsalo cuando el usuario necesite construir, ordenar o fortalecer un marco teórico o estado del arte, integrando autores, enfoques, debates, vacíos, antecedentes y líneas conceptuales sin convertir la sección en una lista de resúmenes aislados.
---
...
- Para organizar literatura: lee [references/organizacion-de-literatura.md](references/organizacion-de-literatura.md).
