...
Leer [fuentes oficiales](references/fuentes-oficiales.md) antes de citar PRISMA o elegir documentos. No copiar una lista obsoleta de PRISMA 2009 cuando corresponde PRISMA 2020.
...
2. Consultar [selección de guía y extensiones](references/seleccion-guia-extension.md).
...
Aplicar [protocolo y búsqueda](references/protocolo-busqueda.md). Especificar antes de revisar resultados:
...
Aplicar [evaluación y síntesis](references/evaluacion-sintesis.md).
...
Leer [flujo y trazabilidad](references/flujo-trazabilidad.md). Elegir la plantilla oficial para revisión nueva o actualizada y según use solo bases/registros o también otras fuentes.
...
Consultar [fuentes oficiales](references/fuentes-oficiales.md), [selector de extensiones](references/seleccion-guia-extension.md), [protocolo y búsqueda](references/protocolo-busqueda.md), [evaluación y síntesis](references/evaluacion-sintesis.md), [flujo y trazabilidad](references/flujo-trazabilidad.md) y [matriz de reporte](references/matriz-reporte-prisma-2020.md) solo cuando la fase lo requiera.
